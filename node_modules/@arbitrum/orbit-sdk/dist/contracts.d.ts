...
export declare const arbOwnerPublic: {
...
export declare const rollupCreator: {
    readonly address: {
...
export declare const tokenBridgeCreator: {
    readonly address: {
...
export declare const upgradeExecutor: {
    abi: readonly [{
